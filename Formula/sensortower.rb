class Sensortower < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "bfe5c9b3b768b75d2167c38240521316a7b40c486ade417aac2de37722f96cae"
    else
      url "https://github.com/FerdiKT/sensortower-cli/releases/download/v#{version}/sensortower_#{version}_darwin_amd64.tar.gz"
      sha256 "55b322afc4c978c9dc868404e08e88fedcdbcf4526a5ba60d18911f1094b2493"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "d65421d49082c6fa97ca8c0e45b62341ac41f564c5d943c5d4c73c92cc3c80bb"
    else
      url "https://github.com/FerdiKT/sensortower-cli/releases/download/v#{version}/sensortower_#{version}_linux_amd64.tar.gz"
      sha256 "0ef5fc4801d3e793e6d2db23c2c22f534792c139cd98dd54efcbd3ce2f5a9128"
    end
  end
