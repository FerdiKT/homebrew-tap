class Sensortower < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "72c8ed08d0c91330020f826d1e68b241c9dc951de9b6f8896f14ea1ae7fb85a8"
    else
      url "https://github.com/FerdiKT/sensortower-cli/releases/download/v#{version}/sensortower_#{version}_darwin_amd64.tar.gz"
      sha256 "45c55914c2de055bf55eb1b8627a3953c7290bae4d206ec1020e3d7edcf4232e"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "7d6473dd1f5f34b4318b13d37cb4a1c8a02383918b19888a29c446ba0136f018"
    else
      url "https://github.com/FerdiKT/sensortower-cli/releases/download/v#{version}/sensortower_#{version}_linux_amd64.tar.gz"
      sha256 "32c8b199e10d69e35d6911245590ae8d3f715631c41a2f561acdeb73d470cc7c"
    end
  end
