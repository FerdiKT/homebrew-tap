class Appstore < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/FerdiKT/appstore-cli/releases/download/v0.1.1/appstore_0.1.1_darwin_arm64.tar.gz"
      sha256 "63355b109c41126f8a8c19372b83efaab1d74f5c2576a178b13c21a05979f131"
    else
